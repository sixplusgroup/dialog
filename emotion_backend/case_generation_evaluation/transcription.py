...
class RequestApi(object):
    ...
    def get_result_request(self, taskid):
        response = requests.post(lfasr_host + api_get_result, data=self.gene_params(api_get_result, taskid=taskid), files=None, headers=None)
        result = json.loads(response.text)
        return result
...
if __name__ == '__main__':
    api = RequestApi(appid="b282f23a", secret_key="7be165c8d7130cc3c093cd986e89d8a7", upload_file_path=r"E:\Program\Pycharm\毕设\录音new\130010193820217094447855.wav")
